...
public class PlayerController : MonoBehaviour {
    ...
    void DoubleJump()
    {
        grounded = Physics2D.OverlapBox(transform.position + new Vector3(0, -1.6f, 0), new Vector2(1.2f, 0.1f), 0, groundMask);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(transform.position + new Vector3(0, -1.6f, 0), new Vector3(1.2f, 0.1f, 0.1f));
    }
